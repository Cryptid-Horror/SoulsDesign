<?php
    ...
    $marking_can = [
        ...
        'Radiance when paired with another color modifier, if they are the same, can create a dominant color modifier effect. Example, having nRad-Azure and nAz in the same genome, you can have dominate Azure effects on the dragon.',
...
'You must use the sliders for the color code your radiance recieves. Go to that color gene page for that information!',
    ];
