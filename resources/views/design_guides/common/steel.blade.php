<?php
    ...
    $marking_can = [
        ...
        'steel has a very special ability where it can modify other color genes, when modifying other color genes, you can use the slides below for the base coats (or markings! You do not need to use the sliders for the marking).'
    ];
    ...
    $marking_must = [
        ...
        ' steel is shades of light grey, to dark grey. It also has small tints of color to create incredibly desaturated forms of colors, far more desaturated than the Haze base coat can create.',
...
citrine is applied to the base. Smoke is base dependant and is now shades of citrine. Stained is layered above smoke and is now also shades of citrine overtop of smoke. Duotone is applied to stained, and now stained has two shades of citrine applies. Ontop of this, dusted is residing above all these markings, and is allowed to be shades of citrine as well.',
    ...
    $swatches = [
        'GREYING','amy_steel','citrine_steel', 
    ];

    // Design examples should be kept in public/images/design_guides/examples/approved_designs
    $design_carousel = [
        ['image_name' => 'steel_1', 'alt' => '...', 'label' => 'SB-0919', 'caption' => 'Designer: @aarushiiroosh'],
        ['image_name' => 'steel_2', 'alt' => '...', 'label' => 'SB-0752', 'caption' => 'Designer: @Cameil'],
        ['image_name' => 'steel_3', 'alt' => '...', 'label' => 'SB-0928', 'caption' => '@Lich-ARPG and @ModernBeatnik'],
    ];
?>
