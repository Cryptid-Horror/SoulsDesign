<?php
    ...
    $modifier_affects = [
        ...
        'Metallic' => ['Accents', 'Birthmark', 'Blush', 'Freckles', 'Minimal Mark', 'Socks', 'Stockings', 'Tips', 
                        ...
                        'Aurora', 'Arcane', 'Simple Harlequin', 'Gemstone', 'Lepir - Simple', 'Rune', 'Triquetra', 'Mermaid', 'Torch', 'Constellation', 'Confetti',
        ...
        'Luminescent' => ['Accents', 'Birthmark', 'Blush', 'Freckles', 'Minimal Mark', 'Socks', 'Stockings', 'Tips',
                          ...
                          'Eyes', 'Filigree', 'Petal', 'Aether Marked', 'Gemstone', 'Rune', 'Triquetra', 'Circuit', 'Confetti', 'Torch', 'Teeth, Claws, horns, Gums, and Import Extras',
