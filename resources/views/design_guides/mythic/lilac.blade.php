<?php
    $marking_icon = 'Mythic_Lilac';
    $marking_name = 'Lilac';
    $marking_code = 'nLi/LiLi';
    ...
    $marking_must = [
        ...
        'Lilac is shades of purple. It can bleed into purple-reds, etc, but the purple coloration must be strongest.',
...
Flaxen is applied to the base. Smoke is base dependant and is now shades of flaxen. Stained is layered above smoke and is now also shades of flaxen overtop of smoke. Duotone is applied to stained, and now stained has two shades of flaxen applies. Ontop of this, dusted is residing above all these markings, and is allowed to be shades of flaxen as well.',
    ...
    $design_carousel = [
        ['image_name' => 'lilac_1', 'alt' => '...', 'label' => 'SB-0821', 'caption' => 'Designer: @Rhith'],
        ['image_name' => 'lilac_2', 'alt' => '...', 'label' => 'SB-0661', 'caption' => 'Designer: @Rhith'],
        ['image_name' => 'lilac_3', 'alt' => '...', 'label' => 'SB-0168', 'caption' => 'Designer: @GryAdventures + @Oreleth'],
    ];
?>
