...
@section('profile-title') {{ $user->name }}'s Ethereal Rank @endsection
...
<div class="mb-4 text-center">
    <div class="card text-center">
        <div class="m-4"><strong>Ethereal Rank:</strong> <br>{{ $user->level->current_level }}</div>
        <div class="m-4"><strong>Current Ethereal Experience:</strong> <br>{{ $user->level->current_exp }} </div>
