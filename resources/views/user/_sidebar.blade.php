<ul>
    ...
    <li class="sidebar-section">
        <div class="sidebar-section-header">User Account</div>
        ...
        <div class="sidebar-item"><a href="{{ $user->url.'/characters' }}" class="{{ set_active('user/'.$user->name.'/characters*') }}">Dragons</a></div>
        ...
        <div class="sidebar-item"><a href="{{ $user->url.'/level' }}" class="{{ set_active('user/'.$user->name.'/level*') }}">User Level Area</a></div>
    ...
    <li class="sidebar-section">
        <div class="sidebar-section-header">User Gallery</div>
...
<div id="accordion">
    <li class="sidebar-section">
    <div class="sidebar-section-header pointer collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><i class="fas fa-sort-down"></i> User Logs</div>
