...
@php
    ...
    <div class="progress" style="height: 20px; width: 50%;" >
        <div class="progress-bar bg-success text-dark h4" style="width:100%; {{ isset($health->current_count) ? $health->current_count : 100 }}%" role="progressbar" aria-valuenow="{{ $health->current_count}}" aria-valuemin="0" aria-valuemax="{{ $health->current_count }}" style="height:100%; width:{{ isset($health->current_count) ? $health->current_count : 100 }}%">
