...
@if($status == 'draft')
    ...
    <p>Design approval requests allow you to submit updates to your character's design, or submit a finished design for a Registered Dragon slot. To create a new approval request, go to the character or Registered Dragon slot's page and choose "Update Design" from the sidebar.</p>
@else
    <h1>
        Design Approvals
    </h1>
...
@if(count($requests))
    ...
    <table class="table table-sm">
        <thead>
            <tr>
                <th>Character/Registered Dragon Slot</th>
