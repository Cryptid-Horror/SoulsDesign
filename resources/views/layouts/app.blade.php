...
<head>
    ...
    <meta name="description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Mythical ARPG | As Above So Below') }} @endif">
    ...
    <meta property="og:description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Mythical ARPG | As Above So Below') }} @endif">
    ...
    <meta property="twitter:description" content="@if(View::hasSection('meta-desc')) @yield('meta-desc') @else {{ config('lorekeeper.settings.site_desc', 'A Mythical ARPG | As Above So Below') }} @endif">
            ...
            $(function() {
                ...
                function time() {
                    setInterval(function() { 
                        ...
                        var time = new Date(date.getTime() - 60*61*1000*6);  // preform function on first date (basically get time in timestamp format, the 60*60*1000 is an offset of +1 hour. To do other timezones just convert it to the necessary amount of hours +- UTC
