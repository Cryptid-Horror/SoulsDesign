...
@if($submission->status == 'Pending')
    ...
    <div class="mb-1">
        ...
        @if($submission->prompt_id)
            ...
            <div class="row">
                <div class="col-md-2 col-4"><h5> {{ $count }} Previous Submissions{!! add_help('This is the number of times the user has submitted this prompt before, pending or approved.') !!}</h5></div>
        ...
        <table>
            <tr class="character-reward-row">
                ...
                <td class="d-flex align-items-center">
                    {!! Form::text('character_quantity[]', 1, ['class' => 'form-control mr-2  character-rewardable-quantity']) !!}
