<h1>Registered Dragon Slot Settings</h1>
...
<div class="alert alert-info">
    These are displayed on the Registered Dragon slot's profile, but don't have any effect on site functionality except for the following: 
    <ul>
        <li>If all switches are off, the Registered Dragon slot cannot be transferred by the user (directly or through trades).</li>
        <li>If a transfer cooldown is set, the Registered Dragon slot also cannot be transferred by the user (directly or through trades) until the cooldown is up.</li>
    </ul>
</div>
<div class="form-group">
...
<div class="card mb-3" id="resellOptions">
    <div class="card-body">
        {!! Form::label('Resale Value') !!} {!! add_help('This value is publicly displayed on the Registered Dragon slot\'s page.') !!}
