...
function rollBchampion(){
    if (zone.value == "basic"){
        ...
        else if (i <= 40){itemlist += "Dragon Roll Sushi";}
        else if (i <= 45){itemlist += "Niramish";} 
        else if (i <= 50){itemlist += "Rack of Ribs";} 
        ...
        else if (i <= 200){itemlist += "Brawler Booster";}
        else if (i <= 201){itemlist += "Nightshade Booster";}
