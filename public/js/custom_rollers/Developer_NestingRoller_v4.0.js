...
var commonMutations = ["Barbed", "Fanged", "Maned", "Spiked", "Spined", "Luecism", "Abundism", "Eagle Beak"];

var uncommonMutations = ["Tusked", "Feathered Extensions", "Frilled", "Raptor", "Lunar", "Polycerate", "Fisher Beak", "Albino", "Anery"];
...
var veryRarePhysicalMutations = ["Eel", "Elemental", "Warlord", "Vulture", "Icarus", "Triclops", "Crocodile", "Blazer", "Growth", "Aether Mane"];
...
function generateBreath() {
	...
	if (damBreath == Breaths.NONE && sireBreath == Breaths.NONE) {
		if (roll < 93 - bonus) {
			result = "Fire";
        } else if (roll < 94 - bonus) {
            result = "Ice";
        } else if (roll < 95 - bonus) {
            result = "Shadow";
        } else if (roll < 96 - bonus) {
            result = "Lightning";
        } else if (roll < 97 - bonus) {
            result = "Radiation";
        } else if (roll < 98 - bonus) {
            result = "Wind";
        } else if (roll < 99 - bonus) {
            result = "Poison";
        } else (roll < 100 - bonus) {
            result = "Luster";
            }
